...
namespace Fibers
{
    public class Fiber
    {
        ...
        /// </summary>
        /// <remarks>This method should only be used in the fiber _action that's executing.</remarks>
        public void Delete()
        {
        ...
        /// <param name='action'>Fiber _action.</param>
        ...
        /// <summary>
        /// Fiber method that executes the fiber _action.
        /// </summary>
